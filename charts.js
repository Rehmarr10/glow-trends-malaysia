window.addEventListener("DOMContentLoaded", function () {
    ...
    var surveyData = "malaysia_skincare_survey_large.csv";
    var productData = "malaysia_beauty_products_large.csv";
    ...
    var chart8 = {
        ...
        encoding: {
            ...
            y: { field: "Monthly_Spending_RM", aggregate: "mean", type: "quantitative", title: "Average Monthly Spending RM" },
            tooltip: [
