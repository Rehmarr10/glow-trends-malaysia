window.addEventListener("DOMContentLoaded", function () {
    ...
    var chart2 = {
        ...
        transform: [
            ...
            {
                calculate: "datum.Respondents / datum.Total",
                as: "Percentage"
            },
            {
                calculate: "datum.Purchase_Channel + '  ' + format(datum.Percentage, '.1%')",
                as: "Label"
            }
        ],
        hconcat: [
    ...
    /* Chart 5 is the manual SVG map inside index.html, so do NOT embed chart5 here. */
