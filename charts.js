window.addEventListener("DOMContentLoaded", function () {
    ...
    var chart1 = {
        ...
        ...commonConfig,
        data: { url: "malaysia_skincare_survey_large.csv" },
    ...
    var chart3 = {
        ...
        params: [
            {
                name: "categorySelect",
                select: { type: "point", fields: ["Product_Category"] },
                bind: "legend"
            }
        ],
        data: { url: "malaysia_beauty_products_large.csv" },
        mark: { type: "circle", size: 90 },
        encoding: {
            x: { field: "Price_RM", type: "quantitative", title: "Price (RM)" },
            ...
            opacity: {
                condition: { param: "categorySelect", value: 0.85 },
                value: 0.15
            },
            tooltip: [
    ...
    var malaysiaRegions = [
        { Region: "KL", Latitude: 3.1390, Longitude: 101.6869, Average_Spending_RM: 205, Respondents: 120 },
        { Region: "Selangor", Latitude: 3.0738, Longitude: 101.5183, Average_Spending_RM: 218, Respondents: 150 },
        { Region: "Johor", Latitude: 1.4927, Longitude: 103.7414, Average_Spending_RM: 220, Respondents: 135 },
        { Region: "Penang", Latitude: 5.4164, Longitude: 100.3327, Average_Spending_RM: 217, Respondents: 125 },
        { Region: "Perak", Latitude: 4.5975, Longitude: 101.0901, Average_Spending_RM: 221, Respondents: 130 },
        { Region: "Negeri Sembilan", Latitude: 2.7258, Longitude: 101.9424, Average_Spending_RM: 220, Respondents: 110 },
        { Region: "Sabah", Latitude: 5.9804, Longitude: 116.0735, Average_Spending_RM: 243, Respondents: 145 },
        { Region: "Sarawak", Latitude: 1.5533, Longitude: 110.3592, Average_Spending_RM: 235, Respondents: 140 }
    ];
    ...
    var chart5 = {
        ...
        width: 500,
        height: 330,
        projection: { type: "mercator", center: [109, 4], scale: 1150 },
        layer: [
            {
                data: {
            ...
            },
            {
                ...
                encoding: {
                    ...
                    tooltip: [
                        { field: "Region", type: "nominal", title: "Region" },
                        { field: "Average_Spending_RM", type: "quantitative", title: "Average Spending RM" },
    ...
    var chart8 = {
        ...
        encoding: {
            ...
            tooltip: [
                ...
                { field: "Monthly_Spending_RM", aggregate: "mean", type: "quantitative", title: "Average Monthly Spending RM" }
            ]
        },
        width: 320,
        height: 260
